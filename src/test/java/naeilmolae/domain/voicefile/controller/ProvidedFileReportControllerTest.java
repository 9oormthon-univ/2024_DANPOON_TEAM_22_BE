...
class ProvidedFileReportControllerTest extends BaseTest {
    ...
    @Autowired
    ProvidedFileService providedFileService;
    ...
    void likeProvidedFile() {
        ...
        String reportUriString = UriComponentsBuilder.fromUriString(PREFIX + "/{providedFileId}/report")
                ...
                .toUriString();
        ProvidedFileReportRequestDto reason = new ProvidedFileReportRequestDto("reason");
